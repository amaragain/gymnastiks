...
<body>
    ...
    <section>
        <div class="banner">
            <picture>
                <source media="(min-width:1024px)" srcset="/assets/img/banner/gymnastics-programs-viswajit-nikhath-gymnastiks-1000x600.jpg">
                <source media="(min-width:426px)"  srcset="/assets/img/banner/gymnastics-programs-viswajit-nikhath-gymnastiks-768x460.jpg">
                <source media="(min-width:100px)"  srcset="/assets/img/banner/gymnastics-programs-viswajit-nikhath-gymnastiks-425x255.jpg">
                <img src="/assets/img/banner/gymnastics-programs-viswajit-nikhath-gymnastiks-425x255.jpg" alt="Viswajit nikhath gymnastiks" class="img-responsive overlay-enabled" style="aspect-ratio:425/255">
            </picture>
            

            <div class="banner-overlay">
                <h1 class="overlay-title">Gymnastics Programs</h1>
                <p class="overlay-text">
                    We have programs designed for everyone.
                </p>
            </div>
        </div>
    </section>
